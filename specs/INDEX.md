...
| 005 | 005-cyclonedx-sbom-release | CycloneDX SBOM for releases | build, security, infrastructure, documentation | Ship a runtime and a build SBOM as GitHub release assets, generated with `pnpm sbom` and verified in CI | — | in progress |
